...
import { projectSchema, projectUserSchema, updateProjectSchema } from "schemas/projects-schema";
...
projectRouter
    ...
    .get("/api/projetos/:id/usuarios",authUser, projectControllers.getProjectUsers)
    .post("/api/projetos/:id/usuarios",authUser, validate(projectUserSchema, "body"), projectControllers.postProjectUsers)
    .delete("/api/projetos/:id/usuarios/:usuario_id",authUser, projectControllers.deleteProjectUsers);
